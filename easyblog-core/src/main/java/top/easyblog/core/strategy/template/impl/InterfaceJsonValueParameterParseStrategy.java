 ...
 */
@Component
public class InterfaceJsonValueParameterParseStrategy implements TemplateParameterParseStrategy {

    @Override
    public byte getParameterType() {
        return TemplateValueConfigType.INTERFACE_JSON_VALUE.getCode();
    }
