...
public class ArticleEventExample {
    ...
    public ArticleEventExample limit(Integer rows) {
        this.limit = rows;
        return this;
    }

    public ArticleEventExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.limit = rows;
        return this;
    }

    public ArticleEventExample page(Integer page, Integer pageSize) {
