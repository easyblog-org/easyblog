...
public class UserHeaderExample {
    ...
    public UserHeaderExample limit(Integer rows) {
        this.limit = rows;
        return this;
    }

    public UserHeaderExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.limit = rows;
        return this;
    }

    public UserHeaderExample page(Integer page, Integer pageSize) {
