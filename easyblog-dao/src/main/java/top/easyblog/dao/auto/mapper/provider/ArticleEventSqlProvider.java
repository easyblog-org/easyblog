...
import top.easyblog.dao.auto.model.example.ArticleEventExample.Criteria;
import top.easyblog.dao.auto.model.example.ArticleEventExample.Criterion;
import top.easyblog.dao.auto.model.example.ArticleEventExample;

public class ArticleEventSqlProvider {

    public String countByExample(ArticleEventExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("article_event");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ArticleEventExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("article_event");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ArticleEvent record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("article_event");
        
        if (record.getArticleCode() != null) {
            sql.VALUES("article_code", "#{articleCode,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(ArticleEventExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ArticleEvent record = (ArticleEvent) parameter.get("record");
    ...
    public String updateByPrimaryKeySelective(ArticleEvent record) {
        SQL sql = new SQL();
        sql.UPDATE("article_event");
        
        if (record.getArticleCode() != null) {
            sql.SET("article_code = #{articleCode,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, ArticleEventExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
