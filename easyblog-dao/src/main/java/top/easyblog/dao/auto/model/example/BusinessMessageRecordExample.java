...
public class BusinessMessageRecordExample {
    ...
    public BusinessMessageRecordExample() {
    ...
    public BusinessMessageRecordExample limit(Integer rows) {
        this.limit = rows;
        return this;
    }

    public BusinessMessageRecordExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.limit = rows;
        return this;
    }

    public BusinessMessageRecordExample page(Integer page, Integer pageSize) {
