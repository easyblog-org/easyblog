...
import top.easyblog.dao.auto.model.example.ArticleCategoryExample.Criterion;
import top.easyblog.dao.auto.model.example.ArticleCategoryExample;

public class ArticleCategorySqlProvider {

    public String countByExample(ArticleCategoryExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ArticleCategoryExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("article_category");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    protected void applyWhere(SQL sql, ArticleCategoryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
