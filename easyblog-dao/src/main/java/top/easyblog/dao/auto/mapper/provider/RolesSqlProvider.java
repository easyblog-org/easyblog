...
import top.easyblog.dao.auto.model.example.RolesExample.Criteria;
import top.easyblog.dao.auto.model.example.RolesExample.Criterion;
...
public class RolesSqlProvider {
    ...
    protected void applyWhere(SQL sql, RolesExample example, boolean includeExamplePhrase) {
        ...
        List<RolesExample.Criteria> oredCriteria = example.getOredCriteria();
        ...
        for (int i = 0; i < oredCriteria.size(); i++) {
            ...
            if (criteria.isValid()) {
                ...
                for (int j = 0; j < criterions.size(); j++) {
                    RolesExample.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
