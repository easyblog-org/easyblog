...
public class RandomNicknameUtils {
     ...
     * 随机昵称 形容词
     */
    private static final String[] NICK_NAME_HEAD = new String[]{"迷你的", "鲜艳的", "飞快的", "真实的", "清新的", "幸福的", "可耐的", "快乐的", "冷静的", "醉熏的", "潇洒的", "糊涂的",
            ...
            "稳重的", "热情的", "开放的", "含蓄的", "无辜的", "多情的", "纯真的", "拉长的", "热心的", "从容的", "体贴的", "风中的", "曾经的", "追寻的", "儒雅的", "优雅的", "开朗的",
            "外向的", "内向的", "清爽的", "文艺的", "长情的", "平常的", "单身的", "伶俐的", "高大的", "懦弱的", "柔弱的", "爱笑的", "乐观的", "耍酷的", "酷炫的", "神勇的", "年轻的",
            "唠叨的", "无情的", "瘦瘦的", "包容的", "顺心的", "畅快的", "舒适的", "靓丽的", "负责的", "背后的", "简单的", "谦让的", "彩色的", "缥缈的", "欢呼的", "生动的", "复杂的",
            ...
            "安静的", "纯情的", "要减肥的", "迷路的", "烂漫的", "哭泣的", "贤惠的", "苗条的", "温婉的", "发嗲的", "会撒娇的", "贪玩的", "执着的", "花痴的", "想人陪的",
     ...
     * 随机昵称 名词
     */
    private static final String[] NICK_NAME_TAIL = new String[]{"嚓茶", "皮皮虾", "皮卡丘", "马里奥", "小霸王", "凉面", "便当", "毛豆", "花生", "可乐", "灯泡", "哈密瓜", "野狼", "背包", "眼神", "缘分", "雪碧", "人生", "牛排",
            ...
            "鼠标", "手机", "电脑", "书本", "奇迹", "身影", "香烟", "夕阳", "台灯", "宝贝", "皮带", "未来", "钥匙", "心锁", "故事", "花瓣", "滑板", "画笔", "画板", "学姐", "店员",
            ...
            "仙人掌", "衬衫", "大神", "草丛", "早晨", "心情", "茉莉", "流沙", "蜗牛", "冥王星", "战斗机", "猎豹", "棒球", "篮球", "乐曲", "电话", "网络", "世界", "中心", "鱼", "鸡", "狗",
            "老虎", "鸭子", "雨", "羽毛", "翅膀", "外套", "火", "丝袜", "书包", "八宝粥", "钢笔", "冷风", "烤鸡", "大雁", "音响", "招牌", "胡萝卜", "冰棍", "帽子", "菠萝", "蛋挞", "香水",
            "泥猴桃", "吐司", "溪流", "黄豆", "樱桃", "小鸽子", "小蝴蝶", "爆米花", "小鸭子", "花卷", "小海豚", "日记本", "小熊猫", "小懒猪", "小懒虫", "镜子", "荔枝", "曲奇", "金针菇",
            "小松鼠", "小虾米", "酒窝", "紫菜", "金鱼", "柚子", "果汁", "百褶裙", "帆布鞋", "项链", "火龙果", "奇异果", "煎蛋", "唇彩", "小土豆", "高跟鞋", "戒指", "雪糕", "睫毛", "铃铛",
            "手链", "香氛", "红酒", "月光", "酸奶", "银耳汤", "咖啡豆", "小蜜蜂", "小蚂蚁", "棉花糖", "蜡烛", "向日葵", "水蜜桃", "小蝴蝶", "小刺猬", "小丸子", "指甲油", "康乃馨", "糖豆",
            "薯片", "口红", "超短裙", "乌冬面", "冰淇淋", "棒棒糖", "长颈鹿", "豆芽", "发箍", "发夹", "发卡", "发带", "铃铛", "小馒头", "小笼包", "小甜瓜", "冬瓜", "香菇", "小兔子",
            "含羞草", "短靴", "睫毛膏", "小蘑菇", "跳跳糖", "小白菜", "草莓", "柠檬", "月饼", "纸鹤", "百合", "小天鹅", "云朵", "芒果", "面包", "海燕", "小猫咪", "龙猫", "唇膏", "鞋垫",
            "羊", "黑猫", "白猫", "万宝路", "金毛", "山水", "音响", "纸飞机", "烧鹅"};


    private static final Function<Integer, Integer> RANDOM_GENERATOR = input -> (int) (Math.random() * input);
    ...
    public static String generateNickname() {
        return NICK_NAME_HEAD[RANDOM_GENERATOR.apply(NICK_NAME_HEAD.length)] + NICK_NAME_TAIL[RANDOM_GENERATOR.apply(NICK_NAME_TAIL.length)];
    }
